...
# python main.py --iteration 10000 --training_cycle 10 --coreset_buffer_size 10 --lr 0.0001 --dataset_dir './dataparser' --model_save_dir './trained_models' --c_r_class_num 3 --c_n_grid_size 10 --c_n_grid_channel 3
...
def get_args():
    ...
    parser.add_argument("--coreset_type", default='cbrs', help="coreset management type")
