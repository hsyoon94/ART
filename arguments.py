...
def get_args():
    ...
    parser.add_argument("--streaming_data_size", default=8, type=int, help='total training iteration')
    ...
    parser.add_argument("--coreset_buffer_size", default=1000, type=int, help="batch size")
