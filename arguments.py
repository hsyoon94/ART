...
# python main.py --iteration 10000 --training_cycle 10 --coreset_buffer_size 10 --lr 0.0001 --dataset_dir './dataparser' --model_save_dir './trained_models' --c_r_class_num 1
...
def get_args():
    ...
    parser.add_argument("--c_n_grid_size", default=5, type=int, help="batch size")
