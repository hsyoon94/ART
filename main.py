    ...
    if args.experiment == 'husky':
        ...
        if args.offline_learning is False:
            ...
            for cycle_idx in range(args.training_cycle):
                ...
                # Update coreset
                new_data_ipt = full_husky_dataset[full_data_index][0]
                new_data_opt = full_husky_dataset[full_data_index][1]
                ...
                eval_acc = evaluation(args, cycle_idx, model, full_husky_dataset, loss_function, device)
